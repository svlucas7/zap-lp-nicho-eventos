...
Este repositório faz parte do meu portfólio no GitHub. É uma landing page de Eventos desenvolvida profissionalmente (no contexto do meu trabalho) e publicada aqui para demonstrar meu processo, padrões e qualidade de entrega.

- Repositório: https://github.com/svlucas7/zap-lp-nicho-eventos
...
- Copywriting pensado para Eventos, com foco em clareza e escaneabilidade
